...
// Terminal test  is showing this as fail. How do I fix?
    ...
    describe("handles error messages correctly", () => {
        ...
        test("lets you cancel out of an error message", async () => {
            ...
            */
            ...
            await driver.findElement(marnie).clear();
            await driver.findElement(phillip).sendKeys(Key.SPACE, Key.BACK_SPACE);
            await driver.findElement(nameDisplay).click();
            await driver.wait(until.elementLocated());
            expect(await (await driver.findElement()).getText()).toBe(
                "The name field must be between 1 and 30 characters long."
            );
            ...
            //these elements were taken from lines 17-22
